...
9. **Цены:** настроить PriceMatrix (тариф × срок × условие × цена), где `ANY` не обещает остаток, а `CODEX` проверяет один длинный лимит: 30 дней для Free или 7 дней для платного тарифа
