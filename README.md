...
- **Замер лимитов**: мониторинг фактических Codex usage windows с их длительностью, остатком и временем сброса; неизвестные ChatGPT-лимиты не подменяются копией Codex
