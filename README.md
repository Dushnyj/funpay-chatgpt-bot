...
- **Единый лимит Codex**: мониторинг общего agentic-пула Codex/Work/Workspace Agents/Excel с фактической длительностью каждого окна, остатком и временем сброса; отдельного лимита обычных Chat-разговоров в модели нет
